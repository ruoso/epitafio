...
__PACKAGE__->set_primary_key(qw(id_remocao vt_reg tt_ini));
...
Remocao - Registra uma Remoção

=head1 DESCRIPTION

As remoções registram quando um óbito não está mais sob a
responsabilidade de algum dos cemitérios geridos pelo sistema.
